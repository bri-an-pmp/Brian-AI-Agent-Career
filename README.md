...
An AI-powered chatbot that represents Brian Athey's career background, skills, and experience -- built with Gradio, OpenAI, and grounded on a resume and career summary. Visitors can chat with "Brian" to learn about his professional background, and the agent records unanswered questions and visitor contact details for follow-up.
